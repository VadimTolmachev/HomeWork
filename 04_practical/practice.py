...
#
#
# В текущем модуле (lesson_006/python_snippets/01_practice.py) реализовать логику работы с пользователем:
#  начало игры,
...
from engine import put_stones, get_bunches, is_gameover, take_from_bunch
